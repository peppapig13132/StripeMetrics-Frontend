    ...
    <>
      <div className="flex flex-col items-center justify-center px-4 py-28">
        ...
        <div className="py-8 w-[280px]">
          ...
          <button className="bg-indigo-500 hover:bg-indigo-700 px-5 py-2 text-sm leading-5 rounded-md font-semibold text-white w-full" onClick={handleSignup}>Sign up</button>
